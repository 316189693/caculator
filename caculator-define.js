define([
    ...
    Caculator.prototype.evalExpression = function(expression){
    ...
    Caculator.prototype.parseStr = function (str) {
        return parseStr(str);
    };
    ...
    function timeDiff(startTime, endTime, diffType) {
        ...
        switch (diffType) {
            ...
            case "day":
                ...
                break;
            case "diffday":
                var startStr = dateFormat(new Date(startTime), 'yyyy-MM-dd');
                var endStr = dateFormat(new Date(endTime), 'yyyy-MM-dd');
                sTime = new Date(startStr);
                eTime = new Date(endStr);
                timeType =1000*3600*24;
                break;
            default:
                break;
